...
## 環境架構 <br>
![GITHUB](images/asr-architecture.png "asr-architecture")
- 演練環境說明<br>
  ...
  - AP01 內部 IP 為 172.16.10.9，對外服務網址為 demo.brianhsing.fun/wordpress/。外部 IP 位址為 114.32.xxx.223<br>
    ![GITHUB](images/demosite.png "demosite")<br>
...
## 演練流程 <br>
- [Lab1 - 建立復原保存庫](Lab1.md)<br>
- [Lab2 - 建立虛擬網路與堡壘機](Lab2.md)<br>
- [Lab3 - 佈署適用於 VMware 的基礎結構](Lab3.md)<br>
- [Lab4 - 啟用複寫](Lab4.md)<br>
- [Lab5 - 執行災難復原演練](Lab5.md)<br>
- [Lab6 - 設定流量管理員與應用程式閘道](Lab6.md)<br>
- [Lab7 - 清除測試容錯移轉](Lab7.md)<br>
